	 ...
	 if(!$email){ 
	   ...
	   $errorMsg = '';
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $sql = mysqli_query($conn, "SELECT * FROM greetuser WHERE myemail='$email' AND mypass='$db_password' LIMIT 1"); 
         ...
         if($login_check > 0){ 
    			while($row = mysqli_fetch_array($sql,MYSQLI_ASSOC)){
					...
					mysqli_query($conn, "UPDATE greetuser SET lastlogday_date=now() WHERE id='$id' LIMIT 1");
					mysqli_query($conn, "UPDATE greetuser SET lastlogday_ip='$logday_ip' WHERE id='$id' LIMIT 1");
  ...
  <body>
	...
	++++++++++++++++++++++++++++++++++++++++++++ -->
		...
		<div class="wrapper">
			...
			<p> <a href="register.php" class="open-sans"> <i class="fa fa-pencil"></i> I want to open an Account</a></p>
			<br />
