...
//sql query for count user's email list

$Email_listinfo = mysqli_query($conn,"SELECT id FROM email_listname WHERE user_id='$uid' ORDER BY ID ASC") or die(mysqli_error($conn)); // query the person
...
$Sent_listinfo = mysqli_query($conn,"SELECT id FROM email_reporting WHERE sender_id='$uid' ORDER BY ID ASC") or die(mysqli_error($conn)); // query the person

$sent_list_Count = mysqli_num_rows($Sent_listinfo);
  ...
  <body>
	...
	++++++++++++++++++++++++++++++++++++++++++++ -->
		...
		<div class="wrapper">
			...
			<p><?php echo $email_list_Count; ?> list</p>
			
			<a href="Manage_email_list.php"><i class="fa fa-pencil-square-o"> </i> Manage</a>
			<a href="Create_email_list.php" class="margin-left-5"> <i class="fa fa-plus"></i> Create New</a>
			...
			<p><?php echo $greeting_list_Count; ?> list</p>
			
			<a href="magage_greeting_list.php"> <i class="fa fa-pencil-square-o"> </i> Manage</a>
			<a href="Create_greeting_list.php"> <i class="fa fa-plus"></i> Create New</a>
			...
			<p><?php echo $sent_list_Count; ?> Mail Sent</p>
			
			<a href="Manage_sent_list.php"><i class="fa fa-pencil-square-o"> </i> Manage</a>
			
			</div>
			
			</div><!-- /column end -->
			
			<div class="col-md-6"></div><!-- /column end -->
